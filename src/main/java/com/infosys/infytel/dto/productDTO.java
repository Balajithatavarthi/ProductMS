...
public class productDTO {
	...
	@Min(value=10,message="Stock should be greater than 10")
	...
	public static productDTO valueOf(product s2) {
		productDTO s=new productDTO();
		s.setProdId(s2.getProdId());
		s.setProdName(s2.getProdName());
		s.setCategory(s2.getCategory());
		s.setDescription(s2.getDescription());
		s.setImage(s2.getImage());
		s.setProdRating(s2.getProdRating());
		s.setStock(s2.getStock());
		s.setSubCateg(s2.getSubCateg());
		s.setPrice(s2.getPrice());
